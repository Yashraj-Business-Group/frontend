...
const CompanyProfile = () => {
  return (
    <div className="w-full bg-surface-bright pb-24">
      {/* Hero Section */}
      <section className="relative pt-32 pb-24 px-8 bg-primary text-white overflow-hidden">
      ...
      <section className="py-24 text-center px-8">
        ...
        <button className="tactical-gradient text-white px-10 py-4 font-bold uppercase tracking-widest text-sm shadow-lg active:scale-95 transition-transform">
