  ...
  return (
    <main>
      ...
      <section className="relative h-[921px] w-full overflow-hidden">
        ...
        <div className="relative z-10 h-full max-w-7xl mx-auto px-8 flex flex-col justify-center items-start text-white">
          ...
          <h1 className="font-headline text-6xl md:text-8xl font-extrabold tracking-tighter leading-[0.9] mb-8 max-w-4xl">
          ...
          <div className="flex gap-4">
            <button className="tactical-gradient px-10 py-5 font-bold uppercase text-sm tracking-widest hover:-translate-y-1 transition-transform">Get Secured Now</button>
            <button className="border-2 border-white px-10 py-5 font-bold uppercase text-sm tracking-widest hover:bg-white hover:text-primary transition-colors">Our Strategy</button>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-8 bg-surface-container-low">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="p-12 bg-white tactical-shadow">
              <span className="material-symbols-outlined text-5xl text-primary mb-6" data-icon="verified">verified</span>
              <h3 className="font-headline text-2xl font-bold text-primary mb-4">Vast Experience</h3>
              <p className="text-slate-600 leading-relaxed">Decades of operational excellence serving the nation's largest industrial complexes and financial institutions.</p>
            </div>
            <div className="p-12 bg-white tactical-shadow">
              <span className="material-symbols-outlined text-5xl text-primary mb-6" data-icon="military_tech">military_tech</span>
              <h3 className="font-headline text-2xl font-bold text-primary mb-4">Pure Dedication</h3>
              <p className="text-slate-600 leading-relaxed">Our workforce is trained to uphold the highest standards of integrity and tactical discipline in every mission.</p>
            </div>
            <div className="p-12 bg-white tactical-shadow">
              <span className="material-symbols-outlined text-5xl text-primary mb-6" data-icon="workspace_premium">workspace_premium</span>
              <h3 className="font-headline text-2xl font-bold text-primary mb-4">Quality Services</h3>
              <p className="text-slate-600 leading-relaxed">Tailored facility and business solutions designed to optimize your corporate workflow and security posture.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 flex flex-col md:flex-row justify-between items-end gap-8">
            <div className="max-w-2xl">
              ...
              <h2 className="font-headline text-5xl font-black text-primary mt-4 tracking-tighter uppercase">Integrated Business Infrastructure</h2>
            </div>
            <a className="font-bold border-b-4 border-primary text-primary pb-1 uppercase tracking-tighter" href="/services">View All Divisions</a>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group relative aspect-[4/5] bg-primary overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary via-primary/20 to-transparent p-10 flex flex-col justify-end">
                ...
                <a className="inline-flex items-center gap-2 text-white font-bold uppercase text-xs tracking-widest" href="/security-guard">Inquire <span className="material-symbols-outlined">trending_flat</span></a>
              </div>
            </div>
            <div className="group relative aspect-[4/5] bg-primary-container overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary-container via-transparent to-transparent p-10 flex flex-col justify-end">
                ...
                <a className="inline-flex items-center gap-2 text-white font-bold uppercase text-xs tracking-widest" href="/house-keeping">Inquire <span className="material-symbols-outlined">trending_flat</span></a>
              </div>
            </div>
            <div className="group relative aspect-[4/5] bg-tertiary-container overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-tertiary via-transparent to-transparent p-10 flex flex-col justify-end">
                ...
                <a className="inline-flex items-center gap-2 text-white font-bold uppercase text-xs tracking-widest" href="/facility-management">Inquire <span className="material-symbols-outlined">trending_flat</span></a>
              </div>
            </div>
            <div className="bg-surface-container-low p-12 flex flex-col justify-center">
              <span className="material-symbols-outlined text-4xl text-primary mb-6" data-icon="groups">groups</span>
              <h3 className="text-2xl font-headline font-bold text-primary mb-4">Manpower Supply</h3>
              <p className="text-slate-600 mb-8">Deploying skilled, semi-skilled, and specialized labour forces for industrial scale.</p>
              <a className="text-primary font-bold uppercase text-xs tracking-widest flex items-center gap-2" href="/manpower-labour">Details <span className="material-symbols-outlined">chevron_right</span></a>
            </div>
            <div className="bg-surface-container-low p-12 flex flex-col justify-center">
              <span className="material-symbols-outlined text-4xl text-primary mb-6" data-icon="assignment_ind">assignment_ind</span>
              <h3 className="text-2xl font-headline font-bold text-primary mb-4">Contract Staffing</h3>
              <p className="text-slate-600 mb-8">Flexible workforce solutions for seasonal demands and long-term project stability.</p>
              <a className="text-primary font-bold uppercase text-xs tracking-widest flex items-center gap-2" href="/contract-staffing">Details <span className="material-symbols-outlined">chevron_right</span></a>
            </div>
            <div className="bg-surface-container-low p-12 flex flex-col justify-center">
              <span className="material-symbols-outlined text-4xl text-primary mb-6" data-icon="payments">payments</span>
              <h3 className="text-2xl font-headline font-bold text-primary mb-4">Taxation &amp; PF</h3>
              <p className="text-slate-600 mb-8">Regulatory compliance, PF management, and strategic taxation advisory services.</p>
              <a className="text-primary font-bold uppercase text-xs tracking-widest flex items-center gap-2" href="/all-taxation">Details <span className="material-symbols-outlined">chevron_right</span></a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="tactical-gradient py-24 px-8 text-white">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
          <div>
            <div className="text-6xl font-black font-headline tracking-tighter mb-2">02</div>
            <div className="text-blue-200 uppercase font-bold tracking-[0.2em] text-sm">Strategic Offices</div>
          </div>
          <div>
            <div className="text-6xl font-black font-headline tracking-tighter mb-2">16+</div>
            <div className="text-blue-200 uppercase font-bold tracking-[0.2em] text-sm">Cities Presence</div>
          </div>
          <div>
            <div className="text-6xl font-black font-headline tracking-tighter mb-2">110</div>
            <div className="text-blue-200 uppercase font-bold tracking-[0.2em] text-sm">Service Verticals</div>
          </div>
          <div>
            <div className="text-6xl font-black font-headline tracking-tighter mb-2">700+</div>
      ...
      {/* Security Banner */}
      <section className="bg-tertiary-container py-16 px-8 text-white overflow-hidden relative">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
          <h2 className="font-headline text-3xl md:text-5xl font-black uppercase tracking-tighter leading-none max-w-3xl">
      ...
      <section className="py-32 px-8 bg-surface-container-low">
        <div className="max-w-7xl mx-auto">
          <h2 className="font-headline text-4xl font-black text-primary mb-16 uppercase tracking-tighter text-center">Executive Testimonials</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[ 
              ...
              <div key={index} className="bg-white p-12 tactical-shadow border-t-8 border-primary">
                <div className="flex gap-1 mb-6 text-tertiary-container">
                  {[...Array(5)].map((_, i) => (
                    <span key={i} className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                  ))}
                </div>
                <p className="italic text-slate-700 leading-relaxed mb-8">"{test.quote}"</p>
                <div className="font-bold text-primary uppercase text-sm tracking-widest">{test.author}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-16">
            <h2 className="font-headline text-4xl font-black text-primary uppercase tracking-tighter">Field Operations</h2>
      ...
      <section className="py-20 bg-surface-container-low overflow-hidden">
        ...
        <div className="flex space-x-12 animate-scroll-horizontal no-scrollbar overflow-x-auto px-8">
          {[1,2,3,4,5,6,7,8].map(num => (
            <div key={num} className="min-w-[150px] h-12 bg-slate-300 opacity-50 flex items-center justify-center font-black text-slate-500">LOGO {num}</div>
          ))}
        </div>
      </section>

      {/* Brochure Banner */}
      <section className="py-12 px-8 bg-surface-container-highest">
